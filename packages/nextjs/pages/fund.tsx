...
export default function Fund() {
    ...
    const resultSignal = (signal: string) => {
        if (signal == "BUY") {
            ...
            return (
                <>
                    <button className=" h-8 text-red-300 bg-red-600 px-2 rounded-md text-md  font-medium my-2">
                        {signal}
                    </button>
                </>
            );
        ...
        <div className="p-4 h-screen">
            <div className="max-w-md mx-auto dark:bg-white  rounded-xl shadow-lg  overflow-hidden md:max-w-2xl m-6">
                <div className="p-8 w-72 sm:w-80 md:w-96">
                    <div className="mb-5">
                        <label
                            className={`tab h-20 text-center w-full font-semibold ${activeTab === "deposit" ? "bg-secondary text-primary-content" : "text-primary"
                                } mr-2`}
                        ...
                        <label
                            className={`tab h-20 text-center w-full font-semibold  ${activeTab === "withdraw" ? "bg-secondary text-primary-content" : "text-primary"
                                }`}
                    ...
                    {activeTab === "deposit" && (
                        <>
                            ...
                            <button onClick={handleApprove} className="btn btn-primary mr-2">Approve</button>
                    ...
                    <div className="mt-5">
                        ...
                        <h3 className="text-lg leading-6 font-medium text-gray-900"> {oracleStatus == 1 ? resultSignal('BUY') : resultSignal('SELL')}</h3>
                    </div>
                </div>
            </div>
        </div>
